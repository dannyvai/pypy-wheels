...
def is_package_built(package_name):
    built_packages = os.listdir("/home/dwainshtein/wheels/")
    ...
    if len(ret.strip()) > 0:
        for line in ret.split('\n'):
            if package in line:
                ...
                proc = subprocess.Popen(["/home/dwainshtein/pypy3.6-v7.1.1-linux64/bin/pypy3", "setup.py", "bdist_wheel"],stdout=subprocess.PIPE,stderr=subprocess.PIPE)
                ret =  proc.communicate()[0]
                print(ret)
